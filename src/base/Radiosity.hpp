...
public:
	...
	bool	updateMeshColors(std::vector<Vec4f>& spherical1, std::vector<Vec4f>& spherical2, std::vector<float>& spherical3, bool spherical, int bounceToVisualize);
...
protected:
    ...
    struct RadiosityContext
    {
        ...
        std::vector<std::vector<Vec3f>>  m_vecIntermediateResult;
